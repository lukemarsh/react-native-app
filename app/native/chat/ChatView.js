    ...
    if (this.props.isTyping) {
      return (
        <View style={[styles.liYou, { flexDirection: 'row' }]}>
          <Image style={{position: 'absolute', left: 6, bottom: 6, height: 30, width: 30}} height={30} width={30} source={require('./../../images/ACE.png')} />
          <View style={[styles.liYouText, { marginLeft: 35 }]}>
